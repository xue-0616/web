...
export class CKBTransaction {
    @ApiProperty({
        type: [String],
        description: 'dobs lock args list',
        required: true,
    })
    @IsArray()
    ...
    @ApiProperty({
        type: [String],
        description: 'dobs type args list',
        required: true,
    })
    @IsArray()
    sporeTypeArgsList!: string[];
}

export class BuyItemsInputDto {
    @ApiProperty({
        type: [Number],
        description: 'dobs items id list',
        required: true,
    })
    @IsNotEmpty()
    itemIds!: number[];
