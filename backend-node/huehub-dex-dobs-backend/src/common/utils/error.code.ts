...
export const responseType = {
    ...
    UtxoNotLive: {
        message: 'Invalid dobs asset format. The bound UTXO has been spent. Please contact the token issuer.',
        code: 4009,
    },
    UtxoValueNotMatch: {
        message: 'Invalid dobs asset format. The bound UTXO  is not 546 sats. Please contact the token issuer.',
        code: 4010,
    },
};
export const MSG = {
