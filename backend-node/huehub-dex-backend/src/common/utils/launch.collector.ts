...
import { CapacityNotEnoughError, CollectResult, CollectUdtResult, Hex, IndexerCell, IndexerError, MIN_CAPACITY, UdtAmountNotEnoughError, leToU128, toCamelcase } from '@rgbpp-sdk/ckb';
import { CollectConfig } from './launch.interface';
...
export class Collector {
    ...
    async getCells({ lock, type, isDataEmpty = true, outputCapacityRange, }: {
    ...
    collectUdtInputs({ liveCells, needAmount, isMax, }: {
