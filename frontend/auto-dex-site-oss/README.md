...
Greenfield rewrite. Replaces `frontend/auto-dex-site-src/` (decompiled minified bundle).
...
HueHub Auto-DEX — automated trading strategy + position management web UI
