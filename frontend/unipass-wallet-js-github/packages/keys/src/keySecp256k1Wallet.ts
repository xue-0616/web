...
export class KeySecp256k1Wallet extends KeyBase {
  ...
  /**
   * @deprecated This method exposes the raw private key in serialized form.
   * WARNING: Use only for backup/export flows with explicit user consent.
   * Never log or transmit the output over insecure channels.
   */
  public toJson() {
